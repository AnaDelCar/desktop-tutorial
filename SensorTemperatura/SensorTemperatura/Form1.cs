...
namespace SensorTemperatura
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            ArduinoPort.PortName = "COM4"; //DEPENDE DEL EQUIPO
        ...
        private void botConectar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Ingresa un valor valido en el 'LIMITE DE TEMPERATURA' ");
                }
                labConexion.Text = "CONEXION OKE";
                labConexion.ForeColor = System.Drawing.Color.DarkBlue;
            }
            catch
            {
